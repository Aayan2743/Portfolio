...
const UserDashboard = () => {
  ...
  const userInterestedCount = userInteractions.filter(
    i => i.type === 'interested' && i.mobile === user?.phone
  ).length;
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {stats.map((stat, index) => (
          <motion.div
            ...
            className="bg-card rounded-2xl p-6 shadow-card cursor-pointer hover:shadow-elevated transition-shadow group"
          >
