...
const ProjectCard: React.FC<ProjectCardProps> = ({ project, onInterested, onDocument, index }) => {
      ...
      <div className="p-6">
        ...
        <div className="flex flex-wrap gap-2">
          <motion.button
            ...
            className="flex-1 px-4 py-2.5 rounded-lg bg-primary text-primary-foreground text-sm font-medium transition-all hover:shadow-elevated"
          >
            Visit
          </motion.button>
          <motion.button
            ...
            className="flex-1 px-4 py-2.5 rounded-lg bg-accent text-accent-foreground text-sm font-medium transition-all hover:shadow-glow"
          >
            I'm Interested
          </motion.button>
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            onClick={onDocument}
            className="flex-1 px-4 py-2.5 rounded-lg border border-border text-foreground text-sm font-medium transition-all hover:bg-secondary"
          >
            Document
          </motion.button>
        </div>
