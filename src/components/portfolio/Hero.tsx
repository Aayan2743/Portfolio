    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
        <motion.span
          ...
          className="inline-block px-4 py-2 mb-6 rounded-full bg-accent/20 text-accent-foreground text-sm font-medium tracking-wide"
        >
        ...
        >
          ...
          <button 
            ...
            className="px-8 py-4 rounded-full font-semibold text-lg border-2 border-primary-foreground/30 text-primary-foreground bg-transparent transition-all duration-300 hover:bg-primary-foreground/10"
          >
            Get in Touch
          </button>
        </motion.div>
